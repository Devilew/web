                        ...
                        <div class="card mb-4 border-0">
                            ...
                            <form action="input-aksi.php" method="post">		
                                <table>
                                    ...
                                    <tr>
                                        <td>Berat RM</td>
                                        <td><input type="text" name="berat_rm"></td>					
                                    </tr>	
                                    <tr>
                                        <td>Hasil Produksi</td>
                                        <td><input type="text" name="hasil_produksi"></td>					
                                    </tr>	
                                    <tr>
                                        <td>Trimming</td>
                                        <td><input type="text" name="trimming"></td>					
                                    </tr>	
                                    <tr>
                                        <td>Kulit</td>
                                        <td><input type="text" name="kulit"></td>					
                                    </tr>	
                                    <tr>
                                        <td>Billy</td>
                                        <td><input type="text" name="billy"></td>					
                                    </tr>	
                                    <tr>
                                        <td>Daging Kerok</td>
                                        <td><input type="text" name="daging_kerok"></td>					
                                    </tr>	
                                    <tr>
                                        <td>AFALAN</td>
                                        <td><input type="text" name="afalan"></td>					
                                    </tr>	
                                    <tr>
                                        <td>Soaking</td>
                                        <td><input type="text" name="soaking"></td>					
                                    </tr>	
                                    <tr>
                                        <td>Bekuan Soaking</td>
                                        <td><input type="text" name="bekuan_soaking"></td>					
                                    </tr>	
                                    <tr>
                                        <td>Hasil Packing</td>
                                        <td><input type="text" name="hasil_packing"></td>					
                                    </tr>
                                    <tr>
                                        <td><a href="index.php"><button class="btn btn-danger" type="button">Batal</button></a></td>
